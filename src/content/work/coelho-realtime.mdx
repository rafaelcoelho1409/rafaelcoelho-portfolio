...
thumbnail: /work/coelho-realtime/logo.jpg
---
...
The platform demands 16+ GB RAM to run, so you can't spin it up casually — these 53
slides are the verifiable record of the system running in production: live dashboards,
alert routing, MLflow tracking, CI/CD flows. Navigate with arrows or open fullscreen for
the full read.

<PdfViewer
  src="/work/coelho-realtime/COELHORealTime.pdf"
  height="72vh"
  ariaLabel="COELHO RealTime — 53-slide deployment record"
